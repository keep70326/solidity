...
contract ICOToken is IERC20{
    ...
    //constructor
    constructor(string pName, uint8 pDecimals, string pSymbol, uint256 pTotalSupply) public {
        name = pName;
        decimals = pDecimals;
        symbol = pSymbol;
        _totalSupply = pTotalSupply;
        _balance[msg.sender] = _balance[msg.sender].add(_totalSupply);
